...
import com.example.snapfoodtask.di.AppModule_ProvideRetrofitFactory;
import com.example.snapfoodtask.di.AppModule_ProvideSWAPIRepositoryFactory;
import com.example.snapfoodtask.di.AppModule_ProvideSWAPIServiceFactory;
import com.example.snapfoodtask.network.SWAPIService;
import com.example.snapfoodtask.repository.SWAPIRepository;
import com.example.snapfoodtask.ui.screens.MainActivity;
import com.example.snapfoodtask.viewmodel.PersonViewModel;
import com.example.snapfoodtask.viewmodel.PersonViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends App_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return Collections.<String>singleton(PersonViewModel_HiltModules_KeyModule_ProvideFactory.provide());
    }
  ...
  private static final class ViewModelCImpl extends App_HiltComponents.ViewModelC {
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return Collections.<String, Provider<ViewModel>>singletonMap("com.example.snapfoodtask.viewmodel.PersonViewModel", ((Provider) personViewModelProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.snapfoodtask.viewmodel.PersonViewModel 
          return (T) new PersonViewModel(singletonCImpl.sWAPIRepository());
  ...
  private static final class SingletonCImpl extends App_HiltComponents.SingletonC {
    ...
    private SWAPIService sWAPIService() {
      return AppModule_ProvideSWAPIServiceFactory.provideSWAPIService(AppModule_ProvideRetrofitFactory.provideRetrofit());
    }

    private SWAPIRepository sWAPIRepository() {
      return AppModule_ProvideSWAPIRepositoryFactory.provideSWAPIRepository(sWAPIService());
    }
